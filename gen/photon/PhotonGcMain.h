...
PhotonGtRouterError PhotonGcMain_RouterSetRoute(PhotonGcMain* self, PhotonGtAddress address, PhotonGtAddress next_hop);
PhotonGtRouterError PhotonGcMain_RouterDelRoute(PhotonGcMain* self, PhotonGtAddress address);
PhotonGtRouterError PhotonGcMain_RouterSetGroupRoute(PhotonGcMain* self, PhotonGtAddress groupAddress, PhotonGtAddress next_hop);
...
#define PHOTON_COMPONENT_6_GUID PHOTON_GC_SEGMENT_GUID
#define PHOTON_GC_SEGMENT_ID 6
...
#define PHOTON_COMPONENT_7_GUID PHOTON_GC_SEGMENT_SENDER_GUID
#define PHOTON_GC_SEGMENT_SENDER_ID 7
#define PHOTON_GC_SEGMENT_RECEIVER_GUID "ru.mipt.acsl.segmentation.SegmentReceiver"
#define PHOTON_COMPONENT_3_GUID PHOTON_GC_SEGMENT_RECEIVER_GUID
#define PHOTON_GC_SEGMENT_RECEIVER_ID 3
#define PHOTON_GC_IDENTIFICATION_GUID "ru.mipt.acsl.identification.Identification"
#define PHOTON_COMPONENT_8_GUID PHOTON_GC_IDENTIFICATION_GUID
#define PHOTON_GC_IDENTIFICATION_ID 8
